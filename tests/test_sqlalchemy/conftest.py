...
def users(session, User):
    session.add_all(
        [
            ...
            User(name="Mr Praline", age=33, created_at=datetime(2021, 12, 1)),
            User(name="The colonel", age=90, created_at=datetime(2021, 12, 2)),
            User(name="Mr Creosote", age=21, created_at=datetime(2021, 12, 3)),
            User(name="Rabbit of Caerbannog", age=1, created_at=datetime(2021, 12, 4)),
            User(name="Gumbys", age=50, created_at=datetime(2021, 12, 4)),
        ]
    )
